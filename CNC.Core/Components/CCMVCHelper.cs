...
namespace CNC.Core.Components
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString TextBox5For<TModel, TValue>(
          ...
          object htmlAttributes = null)
        {
            return TextBox5For(htmlHelper, expression, Html5InputTypes.text, string.Empty, string.Empty, false, false,false, htmlAttributes);
        }
        ...
        public static MvcHtmlString TextBox5For<TModel, TValue>(
          ...
          object htmlAttributes = null)
        {
            return TextBox5For(htmlHelper, expression, Html5InputTypes.text, title, title, false, false,false, htmlAttributes);
        }
        ...
        public static MvcHtmlString TextBox5For<TModel, TValue>(
          ...
          object htmlAttributes = null)
        {
            return TextBox5For(htmlHelper, expression, type, title, title, false, false,false, htmlAttributes);
        }
        ...
        public static MvcHtmlString TextBox5For<TModel, TValue>(
          ...
          object htmlAttributes = null)
        {
            return TextBox5For(htmlHelper, expression, Html5InputTypes.text, title, title, isRequired, isAutoFocus, isDisable, htmlAttributes);
        }
